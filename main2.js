...
//musics
const bgMusic = new Audio('./resouce/music/bg.mp3')
bgMusic.loop = true
const winMusic = new Audio('./resouce/music/win.mp3')
const loseMusic = new Audio('./resouce/music/lose.mp3')

loader.load( './resouce/model/scene.gltf', function ( gltf ){ // 인형 로드
...
function lookBackward(){
    ...
    gsap.to(doll.rotation, {duration: .45, y: -1.6}) //
